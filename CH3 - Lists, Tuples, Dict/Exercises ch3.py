...
print(f"List of the first 6 years of my life: {years_list}")
...
print(f"Last element after being lowered, reversed and capitalized: {suprise[-1]}")
...
e2f = {'dog': 'chien',
       'cat': 'chat',
       'walrus': 'morse'}
print(f"New dictionary 'e2f': {e2f}")
...
print(f"French-to-English dictionary called f2e from e2f: {f2e}")

# 3.13. Using f2e, print the English equivalent of the French word chien.
print(f"The english equivalent of the french word chien: {f2e['chien']}")

# 3.14. Make and print a set of English words from the keys in e2f.
set_e2f = set(e2f)
print(f"Set 'set_e2f' from 'e2f' dictionary: {set_e2f}")
...
print("Top-level keys in 'life' dictionary:")
